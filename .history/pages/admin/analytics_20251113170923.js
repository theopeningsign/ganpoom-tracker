      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' }}>
            {[
              { key: 'thisMonth', label: '이번 달 (1일~오늘)' },
              { key: 'lastMonth', label: '지난 달 (1일~말일)' },
              { key: 'last3Months', label: '최근 3개월' },
              { key: 'thisYear', label: '올해 (1월~현재)' }
            ].map(option => (
              <button
                key={option.key}
        ...
        {viewMode === 'custom' && (
          <div style={{
            ...
            <h3 style={{ margin: '0 0 20px 0', color: '#2c3e50' }}>
              📊 기간별 요약 ({dateRange.startDate} ~ {dateRange.endDate})
            </h3>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <div style={{ fontSize: '1rem', opacity: 0.9 }}>총 견적요청</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '1rem', opacity: 0.9 }}>총 커미션</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '10px' }}>
                  {analytics.agentStats.filter(agent => agent.quotes > 0).length}
                </div>
                <div style={{ fontSize: '1rem', opacity: 0.9 }}>활성 에이전트</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '10px' }}>
                  {analytics.totalQuotes > 0 ? Math.round(analytics.totalQuotes / analytics.agentStats.filter(agent => agent.quotes > 0).length) : 0}
                </div>
                <div style={{ fontSize: '1rem', opacity: 0.9 }}>평균 실적/에이전트</div>
              </div>
            </div>
            ...
            <div style={{ 
              ...
              💡 기간별 보기에서는 선택한 기간의 전체 요약 통계를 확인할 수 있습니다.
            </div>
          </div>
        )}
                    ...
                    return (
                      <tr key={month.month} style={{ 
                        ...
                        <td style={{ padding: '15px', fontWeight: 'bold' }}>
                          {month.month.split('-')[0]}년 {month.month.split('-')[1]}월
                        </td>
                        <td style={{ padding: '15px', textAlign: 'center', fontWeight: 'bold', fontSize: '1.1rem' }}>
                          {month.quotes}건
                        </td>
