...
export default function SettlementPage() {
  ...
  useEffect(() => {
    ...
    const targetMonth = `${prevYear}-${prevMonth.toString().padStart(2, '0')}`
    
    setSettlementMonth(targetMonth)
    setViewingMonth(targetMonth) // 초기에는 현재 정산월을 보여줌
        ...
        <div style={{
          ...
          <div style={{ padding: '30px' }}>
            ...
            <div style={{ 
              ...
              <Link href="/admin/settlement-report" style={{ textDecoration: 'none' }}>
                <button
                  style={{
                    padding: '15px 40px',
                    background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
