        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              {/* 이전 화면으로 돌아가기 버튼 */}
              <Link href={`/admin/settlement?month=${selectedMonth}`} style={{ textDecoration: 'none' }}>
                <button style={{
                  padding: '10px 12px',
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '2rem', marginBottom: '10px', margin: 0 }}>
              📈 {selectedMonth ? selectedMonth.split('-')[0] : '2025'}년 연간 추세 분석
            </h2>
            <p style={{ fontSize: '1.1rem', margin: 0, opacity: 0.9 }}>
              1월~{selectedMonth ? selectedMonth.split('-')[1] : '10'}월 월별 성과 비교 및 트렌드 분석
            </p>
          </div>
