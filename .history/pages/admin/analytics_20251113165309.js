...
export default function AnalyticsPage() {
  ...
  const handleAgentClick = (agent) => {
    ...
    const agentDetails = {
      ...
      monthlyStats: [
        { month: '2025-06', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2025-07', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2025-08', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2025-09', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2025-10', quotes: Math.floor(Math.random() * 10) + 1 },
