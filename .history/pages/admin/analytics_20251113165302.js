...
export default function AnalyticsPage() {
  ...
  const generateAnalyticsData = () => {
    ...
    const agentStats = savedAgents.length > 0 ? 
      ...
      [
        { agentId: 'Ab3kM9', name: '김철수', quotes: 23, commission: 230000, period: '2025-11' },
        { agentId: 'Xy7nP2', name: '이영희', quotes: 18, commission: 180000, period: '2025-11' },
        { agentId: 'Mn8kL4', name: '박민수', quotes: 15, commission: 150000, period: '2025-11' },
        { agentId: 'Qw9rT5', name: '정미영', quotes: 12, commission: 120000, period: '2025-11' },
        { agentId: 'Er6yU8', name: '최동훈', quotes: 20, commission: 200000, period: '2025-11' },
        { agentId: 'Ty3iO1', name: '한지수', quotes: 16, commission: 160000, period: '2025-11' },
        { agentId: 'Ui7pA4', name: '송민호', quotes: 14, commission: 140000, period: '2025-11' },
        { agentId: 'Op2sD6', name: '윤서연', quotes: 19, commission: 190000, period: '2025-11' },
        { agentId: 'As5dF7', name: '강혜진', quotes: 22, commission: 220000, period: '2025-11' },
        { agentId: 'Gh8jK2', name: '조성민', quotes: 17, commission: 170000, period: '2025-11' },
        { agentId: 'Lm4nB9', name: '신유리', quotes: 21, commission: 210000, period: '2025-11' },
        { agentId: 'Cv6xZ3', name: '홍준석', quotes: 13, commission: 130000, period: '2025-11' },
        { agentId: 'Bn7mQ1', name: '류소영', quotes: 25, commission: 250000, period: '2025-11' },
        { agentId: 'Wq2eR8', name: '임태현', quotes: 11, commission: 110000, period: '2025-11' },
        { agentId: 'Rt5yU4', name: '안미경', quotes: 24, commission: 240000, period: '2025-11' },
        { agentId: 'Pl9oI6', name: '서준호', quotes: 16, commission: 160000, period: '2025-11' },
        { agentId: 'Zx3cV0', name: '김나연', quotes: 18, commission: 180000, period: '2025-11' },
        { agentId: 'Nm1bG5', name: '박상우', quotes: 20, commission: 200000, period: '2025-11' },
        { agentId: 'Hj8kL7', name: '이수진', quotes: 14, commission: 140000, period: '2025-11' },
        { agentId: 'Fd4sA2', name: '최민재', quotes: 19, commission: 190000, period: '2025-11' }
      ]
    ...
    const monthlyStats = [
      { month: '2025-09', quotes: 45, commission: 450000 },
      { month: '2025-10', quotes: 52, commission: 520000 },
      { month: '2025-11', quotes: 56, commission: 560000 }
    ]
  ...
  const handleAgentClick = (agent) => {
    ...
    const agentDetails = {
      ...agent,
      email: `${agent.name.toLowerCase()}@example.com`,
      phone: `010-${Math.floor(Math.random() * 9000) + 1000}-${Math.floor(Math.random() * 9000) + 1000}`,
      memo: `${agent.name} 에이전트 - 네이버 블로그 활동`,
      monthlyStats: [
        { month: '2024-06', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2024-07', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2024-08', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2024-09', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2024-10', quotes: Math.floor(Math.random() * 10) + 1 },
        { month: '2024-11', quotes: agent.quotes }
      ]
    }
        ...
        onClick={() => setShowAgentModal(false)}>
          ...
          onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{
              ...
              <h3 style={{ margin: '0 0 15px 0' }}>📊 11월 실적</h3>
                    ...
                    <tr>
                      {selectedAgent.monthlyStats.map((stat) => (
                        <td key={stat.month} style={{
                          ...
                          fontSize: '1.1rem',
                          fontWeight: 'bold',
                          color: stat.month === '2024-11' ? '#007bff' : '#495057',
                          background: stat.month === '2024-11' ? '#e3f2fd' : 'transparent'
                        }}>
                          {stat.quotes}건
                        </td>
                      ))}
