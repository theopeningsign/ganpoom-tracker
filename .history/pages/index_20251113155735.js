          ...
          <div style={{
            ...
            <Link href="/admin/settlement" style={{ textDecoration: 'none' }}>
              ...
              onMouseOut={(e) => {
                ...
                <div style={{ fontSize: '2rem', marginBottom: '10px' }}>💰</div>
                <h3 style={{ margin: '0 0 8px 0', fontSize: '1.2rem' }}>정산 관리</h3>
                <p style={{ margin: 0, opacity: 0.9, fontSize: '0.9rem' }}>월별 커미션 정산</p>
              </div>
            </Link>
            ...
            <Link href="/admin/test" style={{ textDecoration: 'none' }}>
              ...
              onMouseOut={(e) => {
                ...
                <div style={{ fontSize: '2rem', marginBottom: '10px' }}>📊</div>
                <h3 style={{ margin: '0 0 8px 0', fontSize: '1.2rem' }}>대시보드</h3>
                <p style={{ margin: 0, opacity: 0.9, fontSize: '0.9rem' }}>상세 분석 및 통계</p>
              </div>
            </Link>
