          ...
          <div style={{
            ...
            <Link href="/admin/agents" style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                <h3 style={{ margin: '0 0 10px 0', fontSize: '1.4rem', fontWeight: 'bold' }}>에이전트 관리</h3>
                <p style={{ margin: 0, opacity: 0.9, fontSize: '1rem' }}>새 에이전트 생성 및 관리</p>
              </div>
            </Link>
            ...
            <Link href="/admin/analytics" style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                <div style={{ fontSize: '3rem', marginBottom: '15px' }}>📊</div>
                <h3 style={{ margin: '0 0 10px 0', fontSize: '1.4rem', fontWeight: 'bold' }}>상세 통계</h3>
                <p style={{ margin: 0, opacity: 0.9, fontSize: '1rem' }}>월별/일별 상세 분석</p>
              </div>
            </Link>
