...
(function() {
    ...
    const GanpoomTracker = {
        ...
        estimateValue: function(formData) {
            // ganpoom.com 서비스별 예상 금액 (실제 데이터로 조정 필요)
            const serviceValues = {
                'website': 5000000,    // 웹사이트 제작: 500만원
                'app': 15000000,       // 앱 개발: 1500만원
                'marketing': 3000000,  // 마케팅: 300만원
                'consulting': 2000000, // 컨설팅: 200만원
                'ecommerce': 8000000,  // 쇼핑몰: 800만원
                'maintenance': 1000000 // 유지보수: 100만원
            };
            
            const serviceType = formData.service || formData.serviceType || 'website';
            return serviceValues[serviceType] || 5000000; // 기본값 500만원
        },
