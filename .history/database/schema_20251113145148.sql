...
CREATE TABLE agents (
    ...
    commission_rate DECIMAL(5,2) DEFAULT 10.00, -- 커미션율 (%)
...
CREATE TABLE quote_requests (
    ...
    commission_amount DECIMAL(12,2), -- 커미션 금액
...
-- 샘플 데이터 (테스트용)
INSERT INTO agents (id, name, memo, commission_rate) VALUES
('Ab3kM9', '김철수', '네이버 블로그', 15.00),
('Xy7nP2', '이영희', '인스타그램', 12.00),
('Qw8rT5', '박민수', '유튜브', 20.00),
('Zx4vB1', '최지은', '페이스북', 10.00);
