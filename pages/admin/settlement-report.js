...
export default function SettlementReportPage() {
  ...
  // 현재 월로 스크롤 이동
  const scrollToCurrentMonth = (targetMonth) => {
    const tableContainer = document.querySelector('.trend-table-container')
    const currentRow = document.querySelector(`[data-month="${targetMonth}"]`)
    ...
    if (tableContainer && currentRow) {
      ...
      // 현재 월이 테이블 중앙에 오도록 스크롤
      const scrollTop = Math.max(0, rowTop - (containerHeight / 2) + (rowHeight / 2))
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{ padding: '30px' }}>
            ...
            className="custom-scrollbar trend-table-container">
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {reportData.map((report, index) => (
                    <tr key={report.month} data-month={report.month} style={{ 
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px' }}>
                ...
                <div>
                  <strong>총 누적 지급액(1월~{viewingMonth ? parseInt(viewingMonth.split('-')[1]) : '10'}월):</strong><br />
                  <span style={{ color: '#1976d2' }}>
